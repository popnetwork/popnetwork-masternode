...
module.exports = class PlayVideoModal extends React.Component {
  constructor(props) {
    super(props)
  ...
  componentDidMount() {
    ...
    this.setState({ torrentSummary })
    console.log('torrent', torrentSummary)
  }
  ...
  render () {
    ...
    const { torrentSummary } = this.state
...
function renderTorrentStatus(torrentSummary) {
  let status
