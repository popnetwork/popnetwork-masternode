...
module.exports = class UpdateAvailableModal extends React.Component {
    render() {
        ...
        return ( <
            ...
            for Windows and Mac.We don 't have one for Linux yet, so you'
            ll have to download the new version manually. <
            /p> <
            ModalOKCancel cancelText = 'SKIP THIS RELEASE'
            onCancel = { handleSkip }
        ...
        function handleShow() {
            ...
            electron.shell.openExternal('https://github.com/popnetwork/popnetwork-masternode/releases')
            dispatch('exitModal')
        }
